...
export function SiteHeader() {
  return <>
    ...
    <header className="sticky top-0 z-20 border-b bg-card/95 backdrop-blur"><div className="mx-auto flex h-18 max-w-6xl items-center justify-between px-4 md:px-6">
      <Link href="/" className="flex items-center gap-3"><span className="flex size-10 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-pink via-brand-violet to-brand-electric text-primary-foreground shadow-lg shadow-brand-violet/25"><Compass className="size-5" aria-hidden="true" /></span><span><strong className="block text-lg font-black leading-none tracking-tight text-brand-navy">Lingshui Expats</strong><small className="mt-1 block text-[10px] font-bold tracking-widest text-brand-pink">陵水外籍人士生活指南</small></span></Link>
